...
if __name__ == '__main__':
    ...
    for i in imgs_list:
        with torch.no_grad():
            ...
            img_resize = cv2.resize(img, (960, 540), interpolation=cv2.INTER_LINEAR)
            ...
            pred_depth_scale = (pred_depth / pred_depth.max() * 60000).astype(np.uint16)  # scale 60000 for vis
