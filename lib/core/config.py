...
__C.TRAIN.NAME = 'debug'
__C.TRAIN.OUTPUT_DIR = '/p300/VNL_RGBD/RGBD/'
# Dir for checkpoint and logs
__C.TRAIN.LOG_DIR = __C.TRAIN.OUTPUT_DIR
# Differ the learning rate between encoder and decoder
__C.TRAIN.SCALE_DECODER_LR = 1
__C.TRAIN.BASE_LR = 0.0005  # 0.0005
...
def merge_cfg_from_file(train_args):
    ...
    __C.TRAIN.NAME = train_args.name
